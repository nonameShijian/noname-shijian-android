...
public class X5WebChromeClient extends WebChromeClient {
    ...
    public void openFileChooser(final ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
        Log.i("uploadMsg", String.valueOf(uploadMsg));
        Log.i("acceptType", String.valueOf(acceptType));
        Log.i("capture", String.valueOf(capture));
    ...
    public boolean onShowFileChooser(WebView webView, final ValueCallback<Uri[]> filePathsCallback, final FileChooserParams fileChooserParams) {
        Log.i("webView", String.valueOf(webView));
        Log.i("filePathsCallback", String.valueOf(filePathsCallback));
        Log.i("fileChooserParams", String.valueOf(fileChooserParams));
        Log.i("getAcceptTypes", Arrays.toString(fileChooserParams.getAcceptTypes()));
